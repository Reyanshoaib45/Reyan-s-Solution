                ...
                <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                    <div className="flex justify-between h-16 items-center">
                        ...
                        <div className="hidden md:flex items-center space-x-8">
                            ...
                            <a href="#process" className="relative text-gray-300 hover:text-blue-400 transition-all duration-300 focus:outline-none focus:text-blue-400 group">
                                <span>Process</span>
                                <span className="absolute -bottom-1 left-0 w-0 h-0.5 bg-gradient-to-r from-blue-400 to-indigo-400 group-hover:w-full transition-all duration-300" />
                            </a>
                            <a href="#team" className="relative text-gray-300 hover:text-blue-400 transition-all duration-300 focus:outline-none focus:text-blue-400 group">
                                <span>Team</span>
                                <span className="absolute -bottom-1 left-0 w-0 h-0.5 bg-gradient-to-r from-blue-400 to-indigo-400 group-hover:w-full transition-all duration-300" />
                            </a>
                            <motion.a
                    ...
                    {isMenuOpen && (
                        ...
                        >
                            <div className="px-2 pt-2 pb-3 space-y-1 sm:px-3">
                                ...
                                <a href="#process" className="block px-3 py-2 text-gray-300 hover:text-blue-400 hover:bg-gray-800 rounded-md transition-all duration-300 focus:outline-none focus:text-blue-400 focus:bg-gray-800 focus:ring-2 focus:ring-blue-500">Process</a>
                                <a href="#team" className="block px-3 py-2 text-gray-300 hover:text-blue-400 hover:bg-gray-800 rounded-md transition-all duration-300 focus:outline-none focus:text-blue-400 focus:bg-gray-800 focus:ring-2 focus:ring-blue-500">Team</a>
